...
DEFAULT_GET_DATA_FIELDS = ['LONG_COMP_NAME','NAME','INDUSTRY_SECTOR','INDUSTRY_GROUP','INDUSTRY_SUBGROUP','SECURITY_TYP', 'CPN', 'MATURITY', 'IS_DAY_PAYER', 'CPN_FREQ',
                           'CV_COMMON_TICKER','ISSUER_PARENT_EQY_TICKER','EQY_PRIM_SECURITY_TICKER','BOND_TO_EQY_TICKER','CORP_TO_EQY_TICKER','PRIMARY_EQUITY_TICKER','BOND_TICKER','ID_CUSIP',
                           ...
                           'ISSUE_DT','FUND_RTG_CLASS_FOCUS','PX_CLOSE_DT','EQY_FUND_CRNCY','REL_INDEX','COMPOSITE_EXCH_CODE','TICKER_AND_EXCH_CODE','ORIG_PRIM_EXCH_CODE','PX_POS_MULT_FACTOR','PX_SCALING_FACTOR','QUOTE_FACTOR','FUND_PRICING_FREQ']

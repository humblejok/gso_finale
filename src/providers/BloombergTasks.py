...
DEFAULT_GET_DATA_FIELDS = ['LONG_COMP_NAME','INDUSTRY_SECTOR','INDUSTRY_GROUP','INDUSTRY_SUBGROUP','SECURITY_TYP',
                           ...
                           'ISSUE_DT','FUND_RTG_CLASS_FOCUS','PX_CLOSE_DT','EQY_FUND_CRNCY','REL_INDEX','COMPOSITE_EXCH_CODE','TICKER_AND_EXCH_CODE','ORIG_PRIM_EXCH_CODE','PX_POS_MULT_FACTOR','PX_SCALING_FACTOR']
